...
{
    public ToDoStatus(TaskManager taskCareTaker) : base(taskCareTaker)
    {
    }
    override public void AdvanceStatus(User assignee)
    {
        _taskCareTaker.SetStatus(new InProgressStatus(_taskCareTaker));
    }
    override public void ActionOnTask()
    {
        Console.WriteLine("the task is in 'TO DO' status");
    }
